...
![The tabs on top of the maun panel, shows tabs for Helsinki, London, adding a new location, editing the location list, and settings](../../images/AstroweatherTabs.png)
